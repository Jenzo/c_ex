...
/**
 * This main method tests various new implemented overloaded operator
 * expressions and statements of SecArr class.
 *
 * @return program exit code as int, but not set
 */
int main(void) {
  int a[] = {1,2,3,4};
